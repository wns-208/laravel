...
<head>
  ...
  <!--Parte das fontes do google - fonts -->
...
<body>
  ...
  <!-- NAV - Barra de navegação com botões-->
  <nav class="nav">
    <!--Logo da persona -->
    <a href="#" class="logo">Grace<span>.</span></a>
    <!--Parte do nav-bar com os botões que levam as suas  respectivas partes -->
    <ul class="nav-links">
      <!--Links para a página sobre, serviços, Portifólio, depoimentos e contato-->
  ...
  <!-- HERO -- Parte de descrição da persona -->
  <header class="hero">
    <div class="hero-text">
      <span class="badge">✦ Disponível para freelance</span>
      <!--Titulo principal isso é mostra tudo oque ela fez-->
      ...
      <div class="cta-row">
        <!--Botões um para iniciar um projeto e outro para ver o portifólio-->
        <a href="#contato" class="btn btn-primary">Iniciar projeto →</a>
        <a href="#portfolio" class="btn btn-ghost">Ver portfólio</a>
      </div>

      <!--Contagen de projetos , Avaliação de projetos, Avaliação média
    ...
    <!-- parte do blog com suas especificações tecnicas
     mostrando que habilidades da persona  -->
  ...
  <!-- Empresas ja trabalhadas e marcas que o cliente já trabalhou como desing -->
  <section class="trust">
  ...
  <section id="sobre" class="section about">
    ...
    <!--agrupa uma parte do texto como no exemplo abaixo "01- sobre mim "-->
      <span class="eyebrow">01 — Sobre mim</span>
    <!--Fala um pouco sobre as caracteristicas artisticas da persona-->
      <h2>Uma designer com olhar artístico e mãos técnicas.</h2>
    </div>
    <div class="about-grid">
      <!--Fala um pouco sobre ela  e sobre sua paixão-->
      ...
      <!--As habilidades profissionais da persona -->
  ...
  <!-- Serviçoes prestados pela persona -->
  <section id="servicos" class="section services">
    <div class="section-head">
      <span class="eyebrow">02 — Serviços</span>
      <h2>O que posso criar pra você</h2>
    </div>
    <!--Toda parte de serviçoes prestados pela persona -->
    <div class="service-grid">
      <article class="service-card">
        <div class="service-icon">Serviços e preços</div>
        ...
        <a href="#contato" class="link">Solicitar orçamento →</a>
      </article>
      <article class="service-card featured">
        <span class="tag-best">Pedido mais pedido</span>
  ...
  <section id="portfolio" class="section portfolio">
    <div class="section-head">
      ...
      <!--Portifolios feitos recentimente-->
      <h2>Projetos recentes</h2>
    </div>
    <div class="portfolio-grid">
      <div class="proj p1"><div class="proj-overlay"><h4>Atelier Lumen</h4><span>Identidade Visual</span></div></div>
      <div class="proj p2"><div class="proj-overlay"><h4>Mira App</h4><span>UI Design</span></div></div>
      <div class="proj p3"><div class="proj-overlay"><h4>Coleção Solstício</h4><span>Ilustração</span></div></div>
      <div class="proj p4"><div class="proj-overlay"><h4>Café Petricor</h4><span>Branding</span></div></div>
      <div class="proj p5"><div class="proj-overlay"><h4>Notas de Crochê</h4><span>Social Media</span></div></div>
      <div class="proj p6"><div class="proj-overlay"><h4>Estúdio 23</h4><span>Identidade Visual</span></div></div>
    </div>
  </section>
  ...
  <section id="depoimentos" class="section testimonials">
    ...
    <div class="testi-grid">
      <blockquote>
        <p>“A Grace entendeu nossa marca como ninguém. Entregou muito além do que esperavamos.”</p>
    ...
    <div class="contact-wrap">
      <div class="contact-left">
        ...
        <ul class="contact-info">
          <li> email de contato: grace.courtney@email.com</li>
          <li> Instagram da marca: @grace.designs</li>
          <li>trabalho temoto para o  mundo todo</li>
        </ul>
      </div>
      <!--Formulario de contato-->
      <!--ousnsubmit manda um alert avisando que o formulario foi enviado-->
      <form class="contact-form" onsubmit="handleSubmit(event)">
        ...
        <div class="field"><label>Tipo de projeto</label>
          <select required>
            <!--Parte de seleção de tipos de projetos-->
        ...
        <!--é um prompt para o cliente falar sobre oque vai ser seu projeto-->
        ...
        <button type="submit" class="btn btn-primary full">Enviar mensagem ✦</button>
        <p class="form-note" id="formNote"></p>
      </form>
    </div>
  </section>

  <!--Toda parte do footer-->
  <footer class="footer">
    <div class="foot-top">
      <div>
        <a href="#" class="logo">Grace<span>.</span></a>
    ...
    <p class="foot-bottom">© 2026 Grace Courtney · Feito com muito carinho e muito café</p>
  </footer>
